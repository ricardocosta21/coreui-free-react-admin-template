...
function Items() {
  ...
  const handleGetAll = (e) => {
    fetch(
      "http://ec2-user@ec2-3-134-102-143.us-east-2.compute.amazonaws.com:8888/api/categories"
    )
      .then((res) => res.json())
      .then((data) => {
        setContacts([...data]);
  ...
  const handlePut = (e) => {
    fetch(
      "http://ec2-user@ec2-3-134-102-143.us-east-2.compute.amazonaws.com:8888/api/categories?newName=" +
        newName,
      {
        method: "PUT",
        headers: {
  ...
  const handleDelete = (e) => {
    fetch(
      "http://ec2-user@ec2-3-134-102-143.us-east-2.compute.amazonaws.com:8888/api/categories?id=" +
        id,
      {
        method: "DELETE",
        headers: {
